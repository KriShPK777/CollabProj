	...
	$rootScope.blogId;
	  ...
	  $scope.addBlog=function()
	  {
		  ...
		  $scope.blogComment.username=$rootScope.currentUser.username;
	 	   ...
	 	   $http.get('http://localhost:8080/MiddleWare/addBlog/',$rootScope.blog)
...
$scope.updateBlog=function()
{
	  ...
	  $http.get('http://localhost:8080/MiddleWare/updateBlog/',$rootScope.blog1)
	   .then(function(response)
	   {
		   alert("Blog Added");
		  ...
		  $http.get('http://localhost:8080/MiddleWare/incrementLikes/'+blogId)
		   .then(function(response)
		   {
			  ...
			  $scope.deleteBlog=function(blogId)
			  {
			  	  ...
			  	  $http.get('http://localhost:8080/MiddleWare/deleteBlog/',$rootScope.blog1)
			  	   .then(function(response)
			  	   {
			  	 ...
			  	 $scope.editBlog=function(blogId)
				  {
					  ...
					  $http.get('http://localhost:8080/MiddleWare/getBlog/'+blogId)
					   .then(function(response)
					   {
				  	  ...
				  	  $scope.accept=function(blogId)
				  	  {
				  	   ...
				  	   $http.get('http://localhost:8080/MiddleWare/approveBlog/',$rootScope.blog)
				 	   .then(function(response)
				 	   {
					     alert("Blog Approved");
				  	  });
				  	 ...
				  	 $scope.reject=function(blogId)
				  	  {
				  	   ...
				  	   $http.get('http://localhost:8080/MiddleWare/rejectBlog/',$rootScope.blog)
				 	   .then(function(response)
				 	   {
					     alert("Blog Rejected");
				  	  });
