myApp.controller("BlogCommentController",function($scope,$http,$location,$rootScope)
{
	...
	function loadAllComments()
	{
		console.log('I am in Comments');
	 	   ...
	 	   $http.get('http://localhost:8080/Frontend/c_blog/BlogCommentController.js',$rootScope.blogId)
      ...
      $scope.addComment=function()
      {
    	  ...
    	  $http.get('http://localhost:8080/Frontend/c_blog/BlogCommentController.js',$scope.blogComment)
	 	   .then(function(response)
	 	   {
